...
from utils.helper_functions import get_row_colors
...
class LiveStreamTab(QWidget):
    ...
    def add_row_to_table(self, text, is_dark_mode=True):
        ...
        try:
            ...
            # Check the theme mode once at the top
            self.is_dark = is_dark_mode 

            bg_color, text_color, severity = get_row_colors(self, engine_severity, e_type)
